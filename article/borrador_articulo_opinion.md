# El plan de tres páginas: por qué leer solo el resumen es no leer el programa

*Borrador — versión 0.1 — junio 2026*

---

La crítica más repetida al programa de gobierno de Abelardo de la Espriella es que cabe en tres páginas. Y tiene algo de razón: existe un documento llamado *Primeras 13 propuestas para reconstruir la Patria Milagro* que, efectivamente, no supera ese número de páginas. El problema con esa crítica es que toma la parte por el todo. Ese documento no es el programa. Es la tarjeta de presentación del programa.
...
## El corpus real: cinco capas documentales

Al revisar el material disponible en el sitio [defensoresdelapatria.com](https://defensoresdelapatria.com/colombia-patria-milagro/), el proyecto programático de De la Espriella se distribuye en al menos cinco capas documentales con funciones distintas.
...
## El modelo económico: más cercano al ajuste que al populismo
...
## La clave que el resumen no muestra
...
## Conclusión: el análisis serio empieza donde el folleto termina
...
Eso no es un ejercicio de simpatía ni de hostilidad. Es el mínimo que merece cualquier proyecto político que aspire a gobernar un país. Los planes de gobierno deben ser leídos por lo que dicen, no por su extensión. Tres páginas es un índice. El análisis comienza en la página cuatro.

---

*Este artículo es parte de un análisis documental más amplio disponible en [github.com/DavidMume/patria-milagro-analysis](https://github.com/DavidMume/patria-milagro-analysis).*
